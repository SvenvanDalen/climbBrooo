...
/**
 * Starts a connected background ClimbPro process right after boot so the watch
 * can reach the app without the user opening it first. WorkManager replays the
 * periodic keep-alive on its own after reboot; this receiver only removes the
